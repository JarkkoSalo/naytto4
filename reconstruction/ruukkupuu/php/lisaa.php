    ...
    <form enctype="multipart/form-data" action="lisaa2.php" method="POST" style="width: 30%; margin: 0 auto;">
	  <input type="hidden" name="MAX_FILE_SIZE" value="30000"/>
        <div class="form-group">
          ...
          <br>
          <input type="text" class="form-control keskita" name="tuotenimi">
        </div>
        ...
        <div class="form-group">
          <h5><b> Tuotteen kuvaus </b></h5>
          <br>
          <textarea name="tuotekuvaus" cols="100" rows="5"></textarea>
        </div>

        <div class="form-group">
          <br>
          <input type="submit" name="nappi" value="Lisää tuote">
        </div>
    </form>
<!--Formi loppuu -->
